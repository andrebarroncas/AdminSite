...
public class RecuperarReceitaPorIdUseCaseTeste
{
    ...
    public async Task Validar_Sucesso()
    {
        ...
        resposta.Categoria.Should().Be((AdminSite.Comunicacao.Enum.Categoria)receita.Categoria);
    ...
    private static RecuperarReceitaPorIdUseCase CriarUseCase(
        AdminSite.Domain.Entidades.Usuario usuario,
        IList<AdminSite.Domain.Entidades.Usuario> usuariosConectados,
        AdminSite.Domain.Entidades.Receita receita)
    {
