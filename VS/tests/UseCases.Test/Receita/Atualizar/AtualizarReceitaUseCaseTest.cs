...
public class AtualizarReceitaUseCaseTest
{
    ...
    public async Task Validar_Sucesso()
    {
        ...
        receita.Categoria.Should().Be((AdminSite.Domain.Enum.Categoria)requisicao.Categoria);
    ...
    private static AtualizarReceitaUseCase CriarUseCase(AdminSite.Domain.Entidades.Usuario usuario, AdminSite.Domain.Entidades.Receita receita)
    {
