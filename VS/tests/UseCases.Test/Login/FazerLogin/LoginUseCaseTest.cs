...
public class LoginUseCaseTest
{
    ...
    public async Task Validar_Sucesso()
    {
        ...
        var resposta = await useCase.Executar(new AdminSite.Comunicacao.Requisicoes.RequisicaoLoginJson
        {
            Email = usuario.Email,
            Senha = senha
        });
    ...
    public async Task Validar_Erro_Senha_Invalida()
    {
        ...
        {
            await useCase.Executar(new AdminSite.Comunicacao.Requisicoes.RequisicaoLoginJson
            {
                Email = usuario.Email,
                Senha = "senhaInvalida"
            });
    ...
    private static LoginUseCase CriarUseCase(AdminSite.Domain.Entidades.Usuario usuario)
    {
