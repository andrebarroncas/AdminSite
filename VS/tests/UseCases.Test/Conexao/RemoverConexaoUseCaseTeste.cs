...
public class RemoverConexaoUseCaseTeste
{
    ...
    public async Task Validar_Sucesso(long usuarioIdParaRemover, IList<AdminSite.Domain.Entidades.Usuario> conexoes)
    {
    ...
    private static RemoverConexaoUseCase CriarUseCase(
        ...
        IList<AdminSite.Domain.Entidades.Usuario> conexoes)
    {
