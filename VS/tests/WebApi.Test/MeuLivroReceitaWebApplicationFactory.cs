...
{
    private AdminSite.Domain.Entidades.Usuario _usuarioComReceita;
    private string _senhaUsarioComReceita;

    private AdminSite.Domain.Entidades.Usuario _usuarioSemReceita;
    private string _senhaUsarioSemReceita;

    private AdminSite.Domain.Entidades.Usuario _usuarioComConexao;
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.UseEnvironment("Test")
            ...
            {
                var descritor = services.SingleOrDefault(d => d.ServiceType == typeof(AdminSiteContext));
                if (descritor is not null)
                    services.Remove(descritor);

                var provider = services.AddEntityFrameworkInMemoryDatabase().BuildServiceProvider();

                services.AddDbContext<AdminSiteContext>(options =>
                {
                ...
                var database = scopeService.GetRequiredService<AdminSiteContext>();
    ...
    public AdminSite.Domain.Entidades.Usuario RecuperarUsuario()
    {
    ...
    public AdminSite.Domain.Entidades.Usuario RecuperarUsuarioSemReceita()
    {
    ...
    public AdminSite.Domain.Entidades.Usuario RecuperarUsuarioComConexao()
    {
