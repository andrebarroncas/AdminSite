...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=AdminSite&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=AdminSite)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=AdminSite&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=AdminSite)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=AdminSite&metric=bugs)](https://sonarcloud.io/summary/new_code?id=AdminSite)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=AdminSite&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=AdminSite)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=AdminSite&metric=coverage)](https://sonarcloud.io/summary/new_code?id=AdminSite)
...
1. Faça o clone do repositório
   ```sh
   git clone https://github.com/welissonArley/AdminSite.git
   ```
...
Você pode acompanhar as correções e problemas encontrados neste projeto [open issues](https://github.com/welissonArley/AdminSite/issues) e ver as novas funcionalidades que serão desenvolvidas e até mesmo as que estão em desenvolvimento no [board do projeto](https://github.com/welissonArley/AdminSite/projects/1).
